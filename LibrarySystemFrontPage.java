...
public class LibrarySystemFrontPage extends JPanel
{
	...
	private ImageIcon image = new ImageIcon(get Class().getResource("librarysystemimage.jpg"));
	private ImageIcon nsearchimage = new ImageIcon(get Class().getResource("nsearchimage.jpg"));
	private ImageIcon asearchimage = new ImageIcon(get Class().getResource("asearchimage.jpg"));
	private ImageIcon askalibrarianimage = new ImageIcon(get Class().getResource("askalibrarianimage.jpg"));
	private ImageIcon searchhistoryimage = new ImageIcon(get Class().getResource("searchhistoryimage.jpg"));
	private ImageIcon myaccountimage = new ImageIcon(get Class().getResource("myaccountimage.jpg"));
	private ImageIcon coursesreservedimage = new ImageIcon(get Class().getResource("coursesreservedimage.jpg"));
   	...
   	public void actionPerformed(ActionEvent buttonClicked)
   	{
		...
		// Advanced Search Clicked
		else if (buttonClicked.getSource() == aSearch)
   		{
			...
			/*AdvancedSearchPage advanced = new AdvancedSearchPage();
		...
		// Courses Reserved Clicked
		else if (buttonClicked.getSource() == reserved)
   		{
			...
			/*CoursesReserved reserve = new CoursesReserved();
